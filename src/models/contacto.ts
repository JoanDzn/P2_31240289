...
export default {
    ...
    create2 (nombre: any, email:any, telefono:any, tarjeta:any, mes:any, ano:any, cvv:any, monto:any, moneda:any) {
        return new Promise((resolve, reject) => {
            const sql2 = `INSERT INTO pagos (id, nombre, email, telefono, tarjeta, mes, ano, cvv, monto, moneda) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
